...
CREATE TABLE `AcademicPosition` (
    ...
    UNIQUE INDEX `AcademicPosition_title_key`(`title`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Teacher` ADD CONSTRAINT `Teacher_academicPositionId_fkey` FOREIGN KEY (`academicPositionId`) REFERENCES `AcademicPosition`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
